...
Agent Management is the foundation of the Supervaize Studio platform. It allows you to discover available AI agents, configure them with the necessary credentials and parameters, and monitor their status and performance.

## <i className="bi bi-1-circle"></i> Discover Newly Added Agent

### Step 1: Access Agent Discovery

Navigate to the **Agents** section in your Supervaize Studio dashboard.
