...
| Aspect           | Description                                                                                                                |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------- |
| **Role**         | Hosts the agent; exposes endpoints (e.g. job_start, job_stop, job_status, job_poll) and optional A2A discovery              |
...
| **Configuration** | Parameters, secrets, and methods (e.g. `job_start`, `job_stop`, `job_status`, `job_poll`) are managed in Supervaize                     |
...
Payload details and example responses are available in the supervaizer repo: [mock_api_responses.py](https://github.com/runwaize/supervaizer/blob/main/tests/mock_api_responses.py).
